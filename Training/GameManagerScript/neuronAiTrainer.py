...
tournament = SwissTournamentManager.SwissTournamentManager(nb, port, client, input_delay=0, time_limit=5 * 60 * 60, first_to=1, ini_path=ini)
...
for i in tournament.ais:
    ...
    i.init(6, 6)
print(tournament.play_tournament())