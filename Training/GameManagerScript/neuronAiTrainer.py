...
tournament = SwissTournamentManager.SwissTournamentManager(nb, port, client, input_delay=0, time_limit=1 * 60 * 60, first_to=3, ini_path=ini)
tournament.ais = [NeuronAI.NeuronAI(random.randint(0, 71), i, -1) for i in range(pop_size)]
